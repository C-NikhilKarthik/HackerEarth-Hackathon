...
batting_model=joblib.load('Multiple_regression.pkl')
batting_scaler=joblib.load('scaled_match_id.pkl')
label_encode_batter=joblib.load('label_encoder_batter.pkl')
label_encode_bowler_2=joblib.load('label_encoder_bowler_batter.pkl')
